...
class PoinTr(nn.Module):
    ...
    def forward(self, xyz):
        ...
        m = nn.Dropout(p=0.4)
        global_feature = m(global_feature)
        ...
        rebuild_points_ = (relative_xyz + coarse_point_cloud.unsqueeze(-1)).transpose(2, 3).reshape(B, -1, 3)  # B N 3
        ...
        ret = (coarse_point_cloud, rebuild_points, rebuild_points_)
        return ret
